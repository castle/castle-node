import { CommandFetchListItemService } from '../../../src/command/command.module';
import { Configuration } from '../../../src/configuration';
import AbortController from 'abort-controller';
import MockDate from 'mockdate';
import { InvalidParametersError } from '../../../src/errors';

describe('CommandFetchListItemService', () => {
  beforeEach(() => {
  ...
  describe('call', () => {
    ...
    it('generates payload', () => {
      const received = CommandFetchListItemService.call(
        controller,
        options,
        config
      );
    ...
    test.each(['list_id', 'id'])(
      ...
      (prop) => {
        ...
        expect(() =>
          CommandFetchListItemService.call(controller, invalidOptions, config)
