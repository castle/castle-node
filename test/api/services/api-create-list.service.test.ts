import { APICreateListService } from '../../../src/api/api.module';
import { Configuration } from '../../../src/configuration';
import fetchMock from 'fetch-mock';

describe('APICreateListService', () => {
  ...
  describe('call', () => {
    it('handles create list response', async () => {
      const apiResponse = {
        name: 'Malicious IPs',
        description:
          'We block these IPs from withdrawing funds. Please be careful.',
      ...
      const response = await APICreateListService.call(
        sampleRequestData,
        config
      );
